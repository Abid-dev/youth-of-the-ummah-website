      ...
      <div class="row">
        <div class="col-lg-8 col-sm-8">
          <div class="left-content">
            <p>Instilling <em>ambition, productivity</em> with strong bonds of <em>brotherhood</em> in the future of the ummah!</p>
          </div>
        </div>
        ...
        <div class="col-lg-12">
          <div class="owl-service-item owl-carousel">
            ...
            <div class="item">
              ...
              <div class="down-content">
                <h4>Obedience of Muhammed (peace be upon him)</h4>
      ...
      <div class="container">
        <div class="row">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="count-area-content">
                      ...
                      <div class="count-title">Dedicated Volunteers</div>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="count-area-content">
                      <div class="count-digit">2</div>
                      <div class="count-title">Masajid we support</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="count-area-content new-students">
                      ...
                      <div class="count-title">Events hosted</div>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="count-area-content percentage">
                      <div class="count-digit">100</div>
                      <div class="count-title">Smiley faces in events 😁</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-6 align-self-center">
            <div class="video">
              <a href="https://www.instagram.com/tv/CYCt2BZhY2h/?utm_medium=share_sheet" target="_blank"><img src="assets/images/play-icon.png" alt=""></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="owl-courses-item owl-carousel">
            <div class="item">
              <img src="assets/images/discussion3.jpg" alt="Sharing Experiences">
              <div class="down-content">
                <h4>Olders Sharing Experiences With Youngers</h4>
              </div>
            </div>
            <div class="item">
              <img src="assets/images/sackRacing.jpeg" alt="Sack Races">
              <div class="down-content">
                <h4>Sack Races</h4>
              </div>
            </div>
            <div class="item">
              <img src="assets/images/tugOfWar.jpeg" alt="Tug of War">
              <div class="down-content">
                <h4>Tug of War</h4>
              </div>
            </div>
            <div class="item">
              <img src="assets/images/dodgeball.jpeg" alt="Dodgeball">
              <div class="down-content">
                <h4>Dodgeball</h4>
              </div>
            </div>
            <div class="item">
              <img src="assets/images/rugBro.jpeg" alt="Rugbro">
              <div class="down-content">
                <h4>Rugbro</h4>
              </div>
            </div>
            <div class="item">
              <img src="assets/images/prizes1.jpeg" alt="Team Prizes">
              <div class="down-content">
                <h4>Winning team prizes</h4>
              </div>
            </div>
            <div class="item">
              <img src="assets/images/discussion7.jpeg" alt="Crash Learning">
              <div class="down-content">
                <h4>Crash Learning</h4>
              </div>
            </div>
            <div class="item">
              <img src="assets/images/discussion1.jpg" alt="Group Discussions">
              <div class="down-content">
        ...
        <div class="col-lg-4">
          <div class="right-info">
            <ul>
              <li>
                <h6>Phone Number</h6>
                <span>+44 7943 821 496</span>
              </li>
              <li>
                <h6>Email Address</h6>
                <span>team@youthoftheummah.com</span>
              </li>
              <li>
                <h6>Website URL</h6>
                <span>www.youthoftheummah.com</span>
              </li>
            </ul>
          </div>
        </div>
